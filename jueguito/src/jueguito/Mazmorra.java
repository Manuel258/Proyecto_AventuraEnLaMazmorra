...
//se mueve dentro de la matriz y evita que salgas del mapa 
	...
	public void iniciarCombate(Enemigo enemigo) {
		...
		while (jugador.getSalud() > 0 && enemigo.getSalud() > 0) {
			...
			System.out.println("Has atacado a " + enemigo.getClass().getSimpleName() + ", su salud ahora es: "
					+ enemigo.getSalud());
			...
			System.out.println(
					enemigo.getClass().getSimpleName() + " te ha atacado, tu salud ahora es: " + jugador.getSalud());
